<template>
    <div>
        ...
        <div class="row gx-2">
            <div class="col-md-30  col-lg-20" v-if="data.advanced">
                <div class="mb-2">
                    <label class="form-label d-flex align-items-center" for="address">
                        Wallet address  
                        <InfoTooltip class="align-self-center ms-2"
				            :content="'Wallet address info'" 
                        />    
                    </label>
            ...
            <div class="col-30" v-if="data.advanced">
                <div class="mb">
                    ...
                    <textarea type="text"   id="comment"
                        ...
                        class="form-control"                 
                        placeholder="any message for trusted partie, visible only to partie, optional"
                        rows="2"                                                            
                    ></textarea>  
                </div>                   
            </div> 
...
const delays = [ 0, 600, 3600, 86400, 1296000, 2592000 ]
...
const contact = computed(() => {
    try {
        return $user.account.contacts.find(c => c.address.toLowerCase() === wallet.address.toLowerCase())
    } catch (error) { }
})
